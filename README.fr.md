...
| `meteors.yaml` | Météores (Perséides, Géminides par registration + empilement max) |
...
4. **Cible**: choisissez le type d'objet (nébuleuse, galaxie, amas, comète, star trails, météores…) et donnez-lui un nom (M42, IC1805…).
